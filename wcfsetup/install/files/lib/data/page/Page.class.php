 ...
 * @property-read	integer		$isDisabled		is `1` if the page is disabled, otherwise `0`
 ...
 * @property-read	integer		$packageID		id of the package the which delivers the page or with which the page is associated
 ...
 * @property-read	integer		$lastUpdateTime		timestamp at which the page was updated the last time
